...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="nav-item" onclick="loadPage('My Schedule', this)"><i class="fa fa-calendar-alt"></i> My Schedule</div>
    ...
    <script>
        function loadPage(page, element) {
                    ...
                    <div style="flex: 1;">
                        <div class="card" style="border-top: 5px solid var(--gold);">
                            ...
                            <ul style="margin-top: 15px; list-style: none;">
                                <li style="padding: 8px 0; border-bottom: 1px solid #eee;"><i class="fa fa-check-circle" style="color:green;"></i> Room 301: Available</li>
                                <li style="padding: 8px 0; border-bottom: 1px solid #eee;"><i class="fa fa-check-circle" style="color:green;"></i> Room 302: Available</li>
                            </ul>
                        </div>
                    </div>
                </div>`;
            } else if(page === 'My Schedule') {
                content.innerHTML = `<h1>My Schedule</h1><div class="card"><p>Your class schedules will appear here.</p>
                 <table>
            ...
            <tbody>
            <?php while($schedule = mysqli_fetch_assoc($sqlStudentSchedule)) { ?>
            <tr>
                <td><?php echo $schedule['reservationId']; ?></td>
                <td><?php echo $schedule['requestedByStudent']; ?></td>
                <td><?php echo $schedule['roomId']; ?></td>
                <td><?php echo $schedule['reservationDate']; ?></td>
                <td><?php echo $schedule['startTime']; ?></td>
                <td><?php echo $schedule['endTime']; ?></td>

                <td>
                    <span style="color:<?php echo ($schedule['status'] === 'Approved') ? 'green' : (($schedule['status'] === 'Pending') ? 'orange' : 'red'); ?>; font-weight:bold;">
                        <?php echo $schedule['status']; ?>
                    </span>
                </td>

                <td><?php echo $schedule['approvedBy']; ?></td>
            </tr>
            <?php } ?>
            </tbody>           
