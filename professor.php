    ...
    <script>
        function loadPage(page, element) {
            ...
            if(page === 'Dashboard') {
                ...
                content.innerHTML = `<h1>My Schedule</h1><div class="card"><p>Your assigned class schedules.</p>
                <table>
            ...
            <tbody>
            <?php while($schedule = mysqli_fetch_assoc($sqlPSchedule)) { ?>
            <tr>
                <td><?php echo $schedule['reservationId']; ?></td>
                <td><?php echo $schedule['roomName']; ?></td>
                <td><?php echo $schedule['lastName']; ?></td>
