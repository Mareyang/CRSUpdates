...
<body>
        ...
        <div class="view-content-wrapper">
            ...
            <section id="dashboard" class="view-section active">
                <div class="meters-grid">
                    <div class="meter-card"><div class="meter-icon-box"><i class="fa-solid fa-list-check"></i></div><div class="meter-info"><p>Total Reservations</p><h3><?php echo $countAdminTotal; ?></h3></div></div>
                    <div class="meter-card"><div class="meter-icon-box"><i class="fa-solid fa-circle-check"></i></div><div class="meter-info"><p>Approved</p><h3><?php echo $countAdminApproved; ?></h3></div></div>
                    <div class="meter-card"><div class="meter-icon-box"><i class="fa-solid fa-hourglass-half"></i></div><div class="meter-info"><p>Pending</p><h3><?php echo $countAdminPending; ?></h3></div></div>
                    <div class="meter-card"><div class="meter-icon-box"><i class="fa-solid fa-circle-xmark"></i></div><div class="meter-info"><p>Rejected</p><h3><?php echo $countAdminRejected; ?></h3></div></div>
                    <div class="meter-card gold-style"><div class="meter-icon-box"><i class="fa-solid fa-door-open"></i></div><div class="meter-info"><p>Total Rooms</p><h3 id="total-rooms-count">--</h3></div></div>
                </div>
                ...
                <div class="dashboard-split-row" style="grid-template-columns: 2fr 1fr;">
                    <div class="content-block-card">
                        <div class="block-header"><h4>Room Availability Overview (Today)</h4></div>
                        <div class="table-container">
                            <table>
                                <thead>
                                    <tr><th>Room</th><th>Capacity</th><th>Status</th><th>Next Booking</th></tr>
                                </thead>
                                <tbody id="dashboard-rooms-availability-tbody">
                                    </tbody>
                            </table>
                        </div>
                    </div>
                    ...
                    <div>
                        <div class="content-block-card">
                            ...
                            <div class="quick-actions-grid">
                                <button class="qa-btn" onclick="alert('Opening Workspace Request Form Wizard...')"><i class="fa-solid fa-plus"></i> New Reservation</button>
                                ...
                                <button class="qa-btn" id="qa-jump-reports"><i class="fa-solid fa-file-invoice"></i> Generate Report</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section id="manage-classrooms" class="view-section">
                <div class="content-block-card" style="margin-bottom: 24px;">
                    ...
                    <form id="form-add-classroom" class="asset-creation-form" action="add.php" method="POST">
                        <div class="filter-input-group"><label>Room Name</label><input type="text" id="input-cls-name" required placeholder="e.g., Room 302" name="roomName"></div>
                        <div class="filter-input-group"><label>Room Floor</label><input type="text" id="input-cls-floor" required placeholder="e.g., 3rd Floor" name="roomFloor"></div>
                        <div class="filter-input-group"><label>Seating Capacity</label><input type="number" id="input-cls-capacity" required placeholder="e.g., 40" min="1" name="capacity"></div>
                        <div class="filter-input-group">
                            <label>Room Status</label>
                            <select id="input-cls-status" name="roomStatus">
                                <option value="Available">Available</option>
                                <option value="Occupied">Occupied</option>
                                <option value="Maintenance">Maintenance</option>
                            </select>
                        </div>
                        <button type="submit" class="btn-form-submit" name="submit-classroom">Save Classroom</button>
                    </form>
                </div>
                <div class="content-block-card">
                    <div class="table-container">
                        <table>
                            ...
                            <tbody id="table-classrooms-tbody">
                                <?php if ($sqlClassrooms) while ($row = mysqli_fetch_assoc($sqlClassrooms)) { ?>
                                <tr id="classroom-row-<?php echo $row['roomId']; ?>">
                                    <td><?php echo htmlspecialchars($row['roomName']); ?></td>
                                    <td><?php echo htmlspecialchars($row['roomFloor']); ?></td>
                                    <td><?php echo htmlspecialchars($row['roomCapacity']); ?></td>
                                    <td><?php echo htmlspecialchars($row['roomStatus']); ?></td>
                                    <td>
                                        <button class="text-action-btn btn-approve-action" onclick="editClassroom(<?php echo $row['roomId']; ?>, '<?php echo htmlspecialchars($row['roomName'], ENT_QUOTES); ?>', '<?php echo htmlspecialchars($row['roomFloor'], ENT_QUOTES); ?>', '<?php echo $row['roomCapacity']; ?>', '<?php echo $row['roomStatus']; ?>')">
                                            <i class="fa-solid fa-pen-to-square"></i> Edit
                                        </button>
                                    </td>
                                    <td>
                                        <button class="text-action-btn btn-reject-action" onclick="deleteClassroom(<?php echo $row['roomId']; ?>, 'classroom-row-<?php echo $row['roomId']; ?>')">
            ...
            <section id="manage-courses" class="view-section">
                <div class="content-block-card" style="margin-bottom: 24px;">
                    ...
                    <form id="form-add-course" class="asset-creation-form" action="add.php" method="POST">
                        <div class="filter-input-group"><label>Subject Code</label><input type="text" id="input-crs-code" name="courseCode" required placeholder="e.g., CS102"></div>
                        <div class="filter-input-group"><label>Course Descriptive Title</label><input type="text" id="input-crs-name" name="courseName" required placeholder="e.g., Data Structures"></div>
                        <div class="filter-input-group"><label>Course Units</label><input type="number" id="input-crs-units" name="units" required placeholder="e.g., 3" min="1"></div>
                        <div class="filter-input-group">
                            <label>Program</label>
                        ...
                        <button type="submit" name="submitCourseAdd" class="btn-form-submit">Save Course</button>
                    </form>
                </div>
                <div class="content-block-card">
                    <div class="table-container">
                        <table>
                            ...
                            <tbody id="table-courses-tbody">
                                <?php if ($sqlCourses) while ($row = mysqli_fetch_assoc($sqlCourses)) { ?>
                                <tr id="course-row-<?php echo $row['courseId']; ?>">
                                    <td><code><?php echo htmlspecialchars($row['courseCode']); ?></code></td>
                                    <td><?php echo htmlspecialchars($row['courseName']); ?></td>
                                    <td><?php echo htmlspecialchars($row['units']); ?></td>
                                    <td>
                                        <button class="text-action-btn btn-approve-action" onclick="editCourse(<?php echo $row['courseId']; ?>, '<?php echo htmlspecialchars($row['courseCode'], ENT_QUOTES); ?>', '<?php echo htmlspecialchars($row['courseName'], ENT_QUOTES); ?>', '<?php echo $row['units']; ?>')">
                                            <i class="fa-solid fa-pen-to-square"></i> Edit
                                        </button>
                                    </td>
                                    <td>
                                        <button class="text-action-btn btn-reject-action" onclick="deleteCourse(<?php echo $row['courseId']; ?>, 'course-row-<?php echo $row['courseCode']; ?>')">
                                            <i class="fa-solid fa-trash"></i> Delete
                                        </button>
                                    </td>
                                </tr>
                    ...
                    <div class="table-container">
                        <table>
                            ...
                            <tbody id="table-students-tbody">
                                <?php while($row = mysqli_fetch_assoc($sqlStudents)){ ?>
                                    <tr id="student-row-<?php echo $row['studentId']; ?>">
                                        ...
                                        <td class="s-lname"><?php echo htmlspecialchars($row['sectionId']); ?></td>
                                        <td>
                    ...
                    <div class="table-container">
                        <table>
                            ...
                            <tbody id="table-teachers-tbody">
                                <?php while($row = mysqli_fetch_assoc($sqlProfessors)){ ?>
    ...
    <script>
        ...
        function renderClassroomsView() {
            document.getElementById('table-classrooms-tbody').innerHTML = classroomsData.map((cls, idx) => `
                <tr><td><strong>${cls.name}</strong></td><td>${cls.capacity}</td><td>${cls.type || 'Lecture Class'}</td>
                <td><button class="action-btn-circle x-btn" onclick="classroomsData.splice(${idx},1); renderClassroomsView(); loadDashboardRoomsAvailability();"><i class="fa-regular fa-trash-can"></i></button></td></tr>
            `).join('');
        }

        function renderCoursesView() { /* table is PHP-rendered */ }

        function renderSectionsView() {
            document.getElementById('table-sections-tbody').innerHTML = sectionsData.map((sec, idx) => `
                <tr><td><strong>${sec.name}</strong></td><td>${sec.year}</td>
                <td><button class="action-btn-circle x-btn" onclick="sectionsData.splice(${idx},1); renderSectionsView();"><i class="fa-regular fa-trash-can"></i></button></td></tr>
            `).join('');
        }

        function renderDirectories() {
            document.getElementById('table-students-tbody').innerHTML = studentsData.map(s => `<tr><td><code>${s.id}</code></td><td><strong>${s.name}</strong></td><td>${s.section}</td></tr>`).join('');
            document.getElementById('table-teachers-tbody').innerHTML = teachersData.map(t => `<tr><td><code>${t.id}</code></td><td><strong>${t.name}</strong></td><td><i class="fa-solid fa-briefcase" style="color:var(--text-muted)"></i> ${t.dept}</td></tr>`).join('');
        }

        // TRANSACTIONAL FORM DISPATCH HANDLERS
        // form-add-classroom and form-add-course use method="POST" action="add.php" — no JS needed
        ...
        document.getElementById('form-edit-course').addEventListener('submit', function(e) {
            ...
            fd.append('courseTitle', document.getElementById('edit-crs-title').value.trim());
            fd.append('courseUnits', document.getElementById('edit-crs-units').value);
            fetch('manage_course.php', { method: 'POST', body: fd })
                .then(r => r.json())
                .then(data => {
                    if (data.success) { closeModal('edit-modal-course'); location.reload(); }
                    else alert('Error: ' + data.message);
                });
        });
